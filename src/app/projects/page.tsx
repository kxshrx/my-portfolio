...
const allProjects = [
  {
    ...
    description:
      "Chrome extension and backend for answering questions about any webpage using AI.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Modern web app for parallel pathfinding algorithms in autonomous navigation.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Deep learning project for segmenting brain tumors in MRI scans.",
    longDescription:
...
const categories = ["All", "GenAI", "Machine Learning", "Algorithms", "Web"];
        ...
        <Container>
          <div className="py-12">
            ...
            <p className="text-gray-300 text-sm mb-8">
              A collection of my work in GenAI, Machine Learning, Algorithms,
              and Web development.
            </p>
